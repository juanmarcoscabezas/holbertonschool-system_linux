 ...
 * Return:
 */
void print_endofline_at_end(size_t directories_number, char option)
{
	static size_t actual_number = 1;

	if (option != 'l' && option != '1')
	{
		if (directories_number > 1 && actual_number < directories_number)
			printf("\n\n");
		else
			printf("\n");
		actual_number++;
	...
	else if (directories_number > 1 && actual_number < directories_number)
		printf("\n");
